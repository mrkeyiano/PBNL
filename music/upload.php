...
include"../topnav.php";
echo"<div class='breadcrumb'><a href='../main.php'>Home</a>&raquo; <a href='index.php'>Music Home</a> &raquo; Add Music</div>";
echo"<center>";
include"../ads.php";
fblike();
...
echo"<div class='center'><ul><span class='style4'>If You don't know how to upload music to Guruszanga please see the below tutorial or don't upload any music !</span></ul></div>";
