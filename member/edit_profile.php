...
$user=$_SESSION["user"];
mysql_query("UPDATE b_users SET name='$name', city='$city', country='$country', note='$note', gender='$gender' , sex='$sex' , school='$school' , position='$position' WHERE username='$user'");
...
<div class='b_head'>Edit Profile<br></DIV>Full Name<br/><input type="text" name="name" value="<?php echo $name; ?>"><br/>City<br/><input type="text" name="city" value="<?php echo $city; ?>"><br/>Country<br/><input type="text" name="country" value="<?php echo $country; ?>"><br/>About me<br/><textarea rows='4' cols='20' name='note'><?php echo $note; ?></textarea><br/><br>
...
<center>Student ,Aspirant Or Graduate <br> <select name='position'><option value='Aspirant'>Aspirant</option><option value='Student'>Student</option>
...
<?php
echo"<br><div class='center'><font color='red'><b>Please fill your Profile details correctly, Dont input your phone number or Email to avoid Spamming !</b></font><br/></div><div class='link_button'><a href='settings.php'>Go Back</a></div>";
include "../footer.php";
?>
