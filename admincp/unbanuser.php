...
*/
require("monit.php");echo "<title>$config->title Manage Users</title>";
echo"<style type='text/css'><!--
.style2 {
        color: #FF0000;
        font-weight: bold;
        font-family: Georgia, 'Times New Roman', Times, serif;
        font-size: 13px; }.style4 {
        color: #FFFFFF;
        font-family: Georgia, 'Times New Roman', Times, serif;
        font-size: 13px;
}
...
echo"<div class='breadcrumb'><a href='../member/index.php'>Home</a> &raquo; Unban Users</div>";
echo"<center>
...
echo"<ul><li>[$i] $st$username<br/><a href='?action=Delete&yes=true&id=$id'>UnBan</a></li></ul>";
...
{ $id=(int)$_GET["id"];
$query=mysql_query("UPDATE b_users SET ban='0' WHERE userID=$id");
if($query)
{
$msg="User UnBanned Successfuly";
}
else
{
$msg=mysql_error();
...
$id=(int)$_GET["id"];
echo"<div class='topnav'>System Warning</div><div class='msg'>Are You Sure You want to Delete This User from Your Database ?</div><div class='gap'></div><div class='button'><a href='?action=Delete&yes=true&id=$id'>
