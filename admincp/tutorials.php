...
echo"<div class='button'><a href='tutorials.php'>Back</a></div>";
exit();
}
else
{
echo"<div class='topnav'><div class='left'><a href='tutorials.php?action=Add'>Create</a></div><div class='right'><a href='tutopics.php'>Topics</a></div></div><div class='gap'></div><div class='center'><ul>Here You can Create New Categories, delete or edit existing category categories</ul></div>";
$msg=$_GET["msg"];
if(!empty($msg))
{
