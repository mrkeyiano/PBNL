...
if(empty($_FILES["file"]) || $_FILES["file"]["size"]==0)
{
mysql_query("INSERT INTO b_uploadcat SET name='$name'") or die(mysql_error());
...
{
echo"<div class='topnav'><div class='left'><a href='uploads.php?action=Add'>Create</a></div><div class='right'><a href='files.php'>Uploaded Files</a></div></div><div class='gap'></div><div class='center'><ul>Here You can Create New Categories, delete or edit existing category categories</ul></div>";
$msg=$_GET["msg"];
if(!empty($msg))
{
