...
*/require("monit.php");
echo "<title>$config->title Search Users</title>";
...
include"topnav.php";
echo"<div class='breadcrumb'><a href='../main.php'>Home</a> &raquo; Search And Delete users</div>";
echo"<center>

<br>
<img src='http://9jacliq.com/images/xmas.png' height='110' width='728'>        <br>
...
echo"<ul><li>[$i] $st$username<br/><a href='?action=Delete&yes=true&id=$id'>Delete</a></li></ul>";
