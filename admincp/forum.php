...
$id=(int)$_GET["id"];
echo"<div class='topnav'>System Warning</div><div class='msg'>Are You Sure You want to Delete This Forum ?</div><div class='gap'></div><div class='button'><a href='?action=Delete&yes=true&id=$id'><font color='red'>Yes</font></a> | <div class='right'><a href='forum.php'>No</a></div></div>";
}
elseif($action=="Edit")
{
$id=(int)$_GET["id"];
...
mysql_query("UPDATE b_forums SET name='$name', img='$img' WHERE id=$id");
...
echo"<div class='button'><a href='forum.php'>Back</a></div>";
exit();
}
elseif($action=="Add")
{
...
{
echo"<div class='topnav'><div class='left'><a href='forum.php?action=Add'>Create</a></div><div class='right'><a href='topics.php'>Forum Topics</a></div></div><div class='gap'></div><div class='center'><ul>Here You can Create New Categories, delete or edit existing forum categories</ul></div>";
$msg=$_GET["msg"];
if(!empty($msg))
{
...
echo"<div class='topnav'><b>Forum Categories</b>($count)</div>";
if($count>0)
{
...
{
echo"<font color='red'><center>No forum created yet</center></font><div class='gap'></div>";
}
