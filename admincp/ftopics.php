...
*/
include('monit.php');
echo"<div class='topnav'><a href='fbt.php'>Fbt Categories</a></div><div class='center'>Here You can move/delete fbt topics</div>";
...
$cname=$cinfo["name"];
$msg="fbt topic moved to $cname category successfully";
...
echo"<ul><li>*<a href='../tutorial/showtopics.php?id=$fid'><b>$name</b></a><br/>Category:- $cat<br/>BY:- $by<br/>$date<br/>$link</li></ul>";
}
if($currentpage>1)
{
...
echo"<div class='button'><a href='fbt.php'>Go Back</a></div>";
include"../footer.php";
?>
