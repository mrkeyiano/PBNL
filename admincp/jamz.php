...
$id=(int)$_GET["id"];
echo"<div class='topnav'>System Warning</div><div class='msg'>Are You Sure You want to Delete This Category ?</div><div class='gap'></div><div class='button'><a href='?action=Delete&yes=true&id=$id'><font color='red'>Yes</font></a> | <div class='right'><a href='uploads.php'>No</a></div></div>";
}
elseif($action=="Edit")
{
$id=(int)$_GET["id"];
...
echo"<div class='button'><a href='uploads.php'>Back</a></div>";
exit();
}
elseif($action=="Add")
{
...
{
echo"<div class='topnav'><div class='left'><a href='jamz.php?action=Add'>Create</a></div>
<div class='left'><a href='".$config->title."music/upload.php'>Upload new music</a></div>
<div class='right'><a href='umusic.php'>Uploaded Files</a></div></div><div class='gap'></div><div class='center'><ul>Here You can Create New Categories, delete or edit existing category categories</ul></div>";
$msg=$_GET["msg"];
if(!empty($msg))
{
...
echo"<div class='topnav'><b>Uploads Categories</b>($count)</div>";
if($count>0)
{
...
if(!empty($img))
{
$img="<img src='/addons/music/$img' height='20' width='20' alt='img' />";
}
else
{
$img="*";
